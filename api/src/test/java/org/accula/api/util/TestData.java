...
public final class TestData {
    ...
    public static final GithubUser userGithub = GithubUser.builder()
        ...
        .isOrganization(false)
        .build();
    public static final GithubUser userGithub1 = GithubUser.builder()
        .id(987456321L)
        .login("user1")
        .avatar("ava")
        .isOrganization(false)
        .build();
    public static final GithubUser userGithub2 = GithubUser.builder()
        .id(789456321L)
        .login("user2")
        .avatar("ava")
        .isOrganization(false)
    ...
    public static final User user1 = new User(id.incrementAndGet(), "zzz", userGithub1, Role.USER);
    public static final User user2 = new User(id.incrementAndGet(), "www", userGithub2, Role.USER);
