...
public class ProjectsRouterTest {
    ...
    private static final Pull[] OPEN_PULLS = new Pull[]{new Pull(), new Pull(), new Pull()};
    ...
    private static final Owner GH_OWNER = new Owner(REPO_OWNER, EMPTY);
    private static final Repo GH_REPO = new Repo(REPO_URL, REPO_NAME, EMPTY, GH_OWNER);
