 ...
 */
public interface ProjectRepository extends ReactiveCrudRepository<ProjectOld, Long> {
    ...
    Mono<ProjectOld> findByRepoOwnerAndRepoName(String repoOwner, String repoName);
