...
import { addRepoToProjectAction } from 'store/projects/actions'
...
interface AddRepoToProjectDialogProps extends PropsFromRedux {
  open: boolean
  onClose?: () => void
}

const AddRepoToProjectDialog = ({ open, onClose, addRepoToProject }: AddRepoToProjectDialogProps) => {
...
const mapDispatchToProps = (dispatch: AppDispatch) => ({
  addRepoToProject: bindActionCreators(addRepoToProjectAction, dispatch)
})
...
export default connector(AddRepoToProjectDialog)
